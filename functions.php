...
if ( ! function_exists( 'coach_setup' ) ) :
	/**
	...
	function coach_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'coach_custom_background_args', array(
...
function coach_scripts() {
	wp_enqueue_style( 'coach-style', get_stylesheet_uri() );

	wp_enqueue_script( 'coach-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'coach-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
