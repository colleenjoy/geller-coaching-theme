 ...
 */
function coach_customize_register( $wp_customize ) {
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial( 'blogname', array(
			...
			'render_callback' => 'coach_customize_partial_blogname',
		) );
		$wp_customize->selective_refresh->add_partial( 'blogdescription', array(
			'selector'        => '.site-description',
			'render_callback' => 'coach_customize_partial_blogdescription',
		) );
	}
}
add_action( 'customize_register', 'coach_customize_register' );
 ...
 * @return void
 */
function coach_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function coach_customize_partial_blogdescription() {
 ...
 */
function coach_customize_preview_js() {
	wp_enqueue_script( 'coach-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_preview_init', 'coach_customize_preview_js' );
